...
node {
	currentBuild.description = "remove Crons on machine Params => PLATFORM: ${env.PLATFORM}, SUB_ENV: ${env.SUB_ENV}, ENV: ${env.ENV}, APPLICATION: ${env.APPLICATION} ";
	...
	stage "remove services"
			commonFunctions.removeServices(env);
