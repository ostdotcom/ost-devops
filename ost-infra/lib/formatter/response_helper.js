...
ResultKlass.prototype = {
  ...
  /**
   * converts the ResultKlass object to Hash object,
   * which can be passed to outside code not having knowledge of ResultKlass
   *
  ...
  toHash: function (errorConfig) {
    ...
    if (!oThis.success) {
      ...
      formattedData.err = {
        ...
        internal_id: oThis.internalErrorCode || 'base_error'
      };
    } else {
...
const ResponseHelperKlass = function (params) {
  ...
  params = params || {};
  oThis.moduleName = params.module_name || 'ost-infra';
};
...
ResponseHelperKlass.prototype = {
  ...
  error: function (params) {
    ...
    console.log('err_code_for_log: ', err_code_for_log, 'internalErrorId: ', internalErrorId,
      'apiErrorId: ', apiErrorId, 'debugOptions: ', debugOptions);
